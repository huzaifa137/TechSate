        ...
        <div class="container">
            ...
            <div class="row g-0 justify-content-center">
                <div class="col-lg-8 wow fadeInUp" data-wow-delay="0.5s">
                    <p class="text-center mb-4">we provide a 24/7 quick response, in case of any query, booking , consultation or any other issue, send us a message we shall respond to you as soon as possible </p>
                    <form>
                        <div class="row g-3">
                            <div class="col-md-6">
